          ...
          {messages.length === 0 && (
            <div style={{ color: 'var(--text3)', padding: '20px 0' }}>
              <p style={{ fontSize: '0.9rem', marginBottom: '16px', color: 'var(--text2)' }}>
                Describe the onboarding content you need and I&apos;ll generate it for you.
              </p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                ...
                {[
                  'Create a Week 1 onboarding checklist for new engineers covering setup, tools and introductions',
                  'Write a company culture guide explaining our values, communication norms and team rituals',
                  'Generate an IT setup guide for new hires: laptop setup, accounts, VPN and security basics',
                ].map(prompt => (
                  <button
                    key={prompt}
