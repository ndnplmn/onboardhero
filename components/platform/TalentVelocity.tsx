...
const depts = [
  { name: 'Engineering', velocity: 78, trend: 'stable' as const },
  { name: 'Product',     velocity: 92, trend: 'up'     as const },
  { name: 'Sales',       velocity: 64, trend: 'down'   as const },
  { name: 'Design',      velocity: 85, trend: 'up'     as const },
]
