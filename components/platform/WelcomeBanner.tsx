  ...
  return (
    <div className="wb glass-panel-pro" style={{ padding: '30px 40px', gap: '24px', position: 'relative', overflow: 'visible' }}>
      <div className="wb-info" style={{ flex: 1 }}>
        <h2 style={{ fontSize: '24px', fontWeight: 850, marginBottom: '8px', display: 'flex', alignItems: 'center', gap: 10 }}>
          <i className="fa-solid fa-hand-wave" style={{ fontSize: 22 }} />
          Welcome to the team, {userName}!
        </h2>
        <p style={{ fontSize: '15px', color: 'var(--text2)', fontWeight: 600 }}>We&apos;re thrilled to have you here. You&apos;re currently on <span style={{ color: 'var(--cyan)', fontWeight: 800 }}>Day {dayNumber}</span> of your onboarding journey.</p>
      </div>
      <img 
