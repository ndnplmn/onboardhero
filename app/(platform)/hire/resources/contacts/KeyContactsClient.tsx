...
const AVAIL_COLOR: Record<ContactData['availability'], string> = {
  available: 'var(--green)',
  busy:      'var(--amber)',
  away:      'var(--text3)',
}

export default function KeyContactsClient({ contacts }: { contacts: ContactData[] }) {
              ...
              >
                ...
                <div className="db-card-hd">
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    {contact.isReal && (
                      <span style={{ fontSize: 9, fontWeight: 700, color: 'var(--green)', background: 'var(--green-bg)', borderRadius: 100, padding: '1px 6px' }}>
                        Assigned
                      </span>
                    )}
                    <a
